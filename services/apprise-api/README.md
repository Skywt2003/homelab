...
Runtime Apprise configuration, including notification credentials, is stored under `/data/homelab/lab/apprise-api/config` and must not be copied into Git.

For credentials provisioned through Compose or bootstrap files, follow the [Secret Management SOP](../../docs/secret-management-sop.md):
